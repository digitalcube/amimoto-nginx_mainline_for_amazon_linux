...
## WorkAround to avoid `missing separator` ...?
# sed '/^MRUBY_MAK_FILE/a $(shell rm -f $(MRUBY_MAK_FILE))' $RPM_BUILD_DIR/%{name}-%{version}/ngx_mruby/Makefile.in -i
...
%changelog
* Wed Nov 13 2024 Yukihiko Sawanobori <sawanoboriyu@higanworks.com>
- 1.27.2
- ngx_mruby 2.7.0
...
- 1.21.3
* Wed Sep 01 2021 Yukihiko Sawanobori <sawanoboriyu@higanworks.com>
- 1.21.2
* Wed Jul 07 2021 Yukihiko Sawanobori <sawanoboriyu@higanworks.com>
- 1.21.1
* Wed May 26 2021 Yukihiko Sawanobori <sawanoboriyu@higanworks.com>
- 1.21.0
